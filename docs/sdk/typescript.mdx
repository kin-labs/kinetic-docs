...
Initialise the SDK so that you have access to all of Mogami's methods.
```ts
...
```
If you're self-hosting Mogami, you can include an optional endpoint value pointing at your server.
